 ...
 * production `/content-checker`) without any template or route knowing
 * about it directly.
 *
 * createUrlHelper('/content-checker')('/login')  -> '/content-checker/login'
 * createUrlHelper('')('/login')                  -> '/login'
 * createUrlHelper('/content-checker')('login')   -> '/content-checker/login'
 * createUrlHelper('/content-checker')('/')       -> '/content-checker/'
 */
